    ...
    <ul class="gallery col-4">
        ...
        <li>
            <div class="preview">
                ...
                <div class="links">
                    <a data-toggle="modal" href="#modal-1" title="Xem giao diện"><i class="icon-eye-open"></i></a><a href="#" title="Đặt mua ngay"><i class="icon-shopping-cart"></i></a>
                </div>
            </div>
            <div class="desc">
            ...
            <div id="modal-1" class="modal hide fade">
                ...
                <div class="modal-body">
                    <img src="images/portfolio/full/index.jpg" alt="">
                </div>
            </div>
        </li>
        <!--/Item 1-->
